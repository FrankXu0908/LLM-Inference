...
def layers():
    ...
    parser.add_argument("--config", default="fx/models/qwen3_5_35b_a3b/config.yaml", help="Model configuration")
    parser.add_argument("--input-text", default="Hello, how are you?", help="Input text for tracing")
    parser.add_argument("--output-dir", default="fx/models/qwen3_5_35b_a3b/artifacts", help="Output directory")
...
def main():
    ...
    output_filename = output_dir / "model_graph.txt"
